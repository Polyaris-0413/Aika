            ...
            item(key = "app-header") {
                ...
                Column(
                    ...
                    Row(
                        ...
                        StatPill(label = stringResource(R.string.stat_pending), count = pendingTasks.size)
                        StatPill(label = stringResource(R.string.stat_completed), count = doneTasks.size)
                    }
                }
            }
...
/** 顶部统计胶囊:pill 形状,底色比任务卡(surfaceContainerHigh)浅一档以示层级 */
@Composable
